...
/**
 * @description form wrapper for `Cell`
 * @example
...
export default class FormCell extends Component {
    static propTypes = {
        /**
         * @property {PropTypes.bool} vcode - if cell use for vcode
         *
         */
        vcode: PropTypes.bool,
        /**
         * @property {PropTypes.bool} warn - display warn style of cell
         *
         */
        warn: PropTypes.bool,
        /**
         * @property {PropTypes.bool} radio - if cell use for radio
         *
         */
        radio: PropTypes.bool,
        /**
         * @property {PropTypes.bool} checkbox - if cell use for checkbox
         *
         */
        checkbox: PropTypes.bool,
        /**
         * @property {PropTypes.bool} switch - if cell use for switch checkbox
         *
         */
        'switch': PropTypes.bool,
        /**
         * @property {PropTypes.bool} select - if cell use for select
         *
         */
        select: PropTypes.bool,
        /**
         * @property {PropTypes.string} selectPos - select position, options: before, after
         *
         */
