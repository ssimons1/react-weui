...
/**
 * @description weui wrapper for form
 * @example
...
class Form extends Component {
    static propTypes = {
        /**
         * @property {PropTypes.bool} radio - if this form is use for radios
         *
         */
        radio: PropTypes.bool,
        /**
         * @property {PropTypes.bool} checkbox - if this form is use for checkbox
         *
         */
