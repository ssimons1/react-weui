...
/**
 * @description Media Object, Typically use with `Panel` to display pictures and text, consists of `MediaBoxBody`, `MediaBoxDescription`, `MediaBoxHeader`
 * @example
 * Created by n7best
 * "use strict";
 * import React from 'react';
...
export default class MediaBox extends React.Component {
    static propTypes = {
        /**
         * @property {PropTypes.string} type - The layout of media box, Options: appmsg/text/small_appmsg
         *
         */
